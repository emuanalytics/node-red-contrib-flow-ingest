...
module.exports = function (RED) {
  ...
  RED.nodes.registerType('flow-mqtt-broker', MQTTBrokerNode, {
    credentials: {
      user: { type: 'text' },
  ...
  function MQTTOutNode(n) {
    ...
    if (this.brokerConn) {
      ...
      this.on('input', function (msg, send, done) {
        ...
        msg.action = node.action || msg.action;
        msg.dataset = node.dataset;
      ...
      const errorTopic = `${this.brokerConn.username}/dataset/${this.dataset}/errors`;
      this.brokerConn.subscribe(
        ...
        function (topic, payload, packet) {
          ...
          var msg = { topic: topic, dataset: node.dataset, payload: payload, qos: packet.qos, retain: packet.retain };
      ...
      this.on('close', function (removed, done) {
        node.brokerConn.unsubscribe(errorTopic, node.id, removed);
  ...
  RED.nodes.registerType('flow ingest', MQTTOutNode);
};
